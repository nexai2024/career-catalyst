...
export default function ProfilePage() {
  ...
  type SkillCategoryKeys = keyof typeof skillCategory;
  const skillKeys: SkillCategoryKeys[] = Object.keys(skillCategory) as SkillCategoryKeys[];
  if (!user) {
  ...
  <span className="text-sm">{user?.yearsOfExperience}  work exp</span>
  </div>
  <div className="flex items-center">
  ...
  Update Profile Picture
          ...
          <Card className="w-full max-w-xs shadow-none lg:col-span-2">
            <CardHeader className="flex flex-row items-center justify-between py-2">
              <div className="flex flex-col items-center">
                <div className="flex items-center gap-3">
                  <Image src="https://github.com/shadcn.png" className="h-8 w-8 rounded-full bg-secondary object-contain" alt="" height={32} width={32} />
                  <div>
            ...
            <CardContent className="p-0">
              ...
              <div className="pt-3 pb-4 px-6">
                ...
                <p className="text-sm text-blue-500">Current Position: {user?.currentPosition}</p>{" "}
                <p className="text-sm text-blue-500">Target Position: {user?.desiredPosition}</p>
              </div>
              <div className="pt-4 items-center flex justify-between px-6">
                <Button variant="ghost" className="w-full text-muted-foreground">
                  <HeartIcon /> <span className="hidden sm:inline">{user?.yearsOfExperience}  work exp</span>
                </Button>
                <Button variant="ghost" className="w-full text-muted-foreground">
                  <MessageCircleIcon /> <span className="hidden sm:inline">{user?.skills?.length} skills</span>
                </Button>
              </div>
            </CardContent>
            <Separator />
            <CardFooter className="flex py-2 px-2">
              <Button variant="ghost" className="w-full text-muted-foreground">
                <HeartIcon /> <span className="hidden sm:inline">Subscription</span>
              </Button>
              <Button variant="ghost" className="w-full text-muted-foreground">
                <MessageCircleIcon /> <span className="hidden sm:inline">Billing</span>
              </Button>
              <Button variant="ghost" className="w-full text-muted-foreground">
            ...
            <Tabs defaultValue="info" className="w-full">
              ...
              <TabsContent value="experience" className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    {user?.experiences && (user.experiences as Experience[]).length > 0 ? (
                      (user.experiences as Experience[]).map((exp, idx) => (
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              <p className="text-sm text-muted-foreground">
                                ...
                                {exp.endDate === null || exp.endDate === undefined ? " Present" :
                      ...
                      <div className="text-muted-foreground">No experiences added yet.</div>
                    )}
                  </CardContent>
                </Card>
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  ...
                                  >
                                    ...
                                    <SelectContent>
                                      {skillKeys.map((key) => (
                                        <SelectItem key={key} value={key}>{skillCategory[key]}</SelectItem>
                                      ))}
                                    </SelectContent>
                                  </Select>
                                </FormControl>
